...
export function Footer() {
  return (
    <footer className="bg-cream-200 text-gray-900 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-gray-700">
              ...
              <li>
                <Link href="/agendar" className="hover:text-brand-700">
                  Agendar consulta
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-2 lg:col-span-3">
            ...
            <Link
              href="/agendar"
              className="mt-4 inline-flex items-center justify-center rounded-full bg-brand-600 hover:bg-brand-700 px-6 py-3 text-sm font-medium text-white w-full transition-colors"
            >
              Agendar consulta
            </Link>
      ...
      <p
        aria-hidden
        className="pointer-events-none font-serif-display text-[18vw] leading-none text-gray-900/10 whitespace-nowrap select-none -mb-6 text-center"
      >
        NutriVerde
      </p>
    </footer>
...
function SocialIcon({ name }: { name: "instagram" | "facebook" | "whatsapp" | "email" }) {
  const className = "text-brand-700";
  switch (name) {
    case "instagram":
      return (
