      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          ...
          <a
            ...
            className="mt-8 block rounded-2xl bg-brand-50 border border-brand-100 p-5 hover:bg-brand-100/60 transition-colors"
          >
            <div className="flex items-start gap-3">
              <span className="h-9 w-9 rounded-full bg-brand-500 text-white flex items-center justify-center shrink-0">
